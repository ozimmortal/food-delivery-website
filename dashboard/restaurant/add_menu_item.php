...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $requiredFields = ['name', 'price', 'restaurant_id'];
        ...
        $stmt = $pdo->prepare("
            ...
            (restaurant_id, name, description, price, image, available) 
            VALUES (?, ?, ?, ?, ?, ?)
        ");
        ...
        header("Location: settings.php?tab=menu&success=Menu+item+added+successfully");
        exit();
